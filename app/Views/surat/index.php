        ...
        <tbody>
            ...
            <?php foreach ($surat as $s) : ?>
                <tr>
                    ...
                    <td><?= $s['perihal']; ?></td>
                    <td>
                        <div class="px-2 py-1 cursor-pointer bg-yellow-500 hover:bg-yellow-600 text-gray-100 rounded shadow text-xs" id="disposisi-btn<?= $s['id']; ?>" onclick="modalDisposisi(<?= $s['id']; ?>)">
                            Disposisi
                        </div>
