                ...
                <?php foreach ($surat as $s) : ?>
                    <tr>
                        ...
                        <td class="text-center justify-center justify-content-center align-items-center">
                            <div class="px-2 py-1 w-5 cursor-pointer text-center justify-center justify-content-center bg-yellow-500 hover:bg-yellow-600 text-gray-100 rounded shadow text-xs" id="disposisi-btn<?= $s['id']; ?>" onclick="modalDisposisi('<?= $s['id']; ?>','<?= $s['perihal']; ?>','<?= $s['dari']; ?>')">
                                Disposisi
                            </div>
                            <div class="text-xs">Menunggu Disposisi</div>
                        </td>
