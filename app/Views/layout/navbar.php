    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          -->
                ...
                <a href="/" class="text-base font-medium bg-primary text-gray-500 hover:text-gray-900">
                    Home
                </a>
                <a href="/pages/about" class="text-base font-medium text-gray-500 hover:text-gray-900">
                    About
                </a>
          ...
          -->
            ...
            <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                ...
                <a href="<?= base_url('logout'); ?>" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                    Logout
                </a>
            </div>
        </div>
