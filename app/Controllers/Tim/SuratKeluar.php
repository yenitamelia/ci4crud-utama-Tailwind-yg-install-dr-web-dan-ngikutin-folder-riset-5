...
class SuratKeluar extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('tim/index_suratkeluar', $data);
    }
    ...
    public function saveSuratKeluar()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/Tim/SuratKeluar/create')->withInput();
        }
    ...
    public function edit($id)
    {
        ...
        return view('tim/edit_suratkeluar', $data);
    }
    ...
    public function update($id)
    {
        ...
        if (!$this->validate([
            ...
            // return redirect()->to('/surat/edit/' . $id)->withInput()->with('validation', $validation);
            // gaperlu ->with('validation',$validation karena withInput() aja udah cukup)
            return redirect()->to('/Tim/SuratKeluar/edit/' . $id)->withInput();
        }
